...
const ProductItem: React.FC<ProductItemProps> = ({ product, categoryId }) => {
  ...
  return (
    <>
      <motion.div
        className="relative bg-white rounded-lg border-gray-100 border  overflow-hidden transition-all duration-300"
        whileHover={{ y: -5 }}
