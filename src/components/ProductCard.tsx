  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
      {categoryProducts.map(
        (product) => product && <ProductItem key={product.id} product={product} categoryId={categoryId} />,
      )}
    </div>
  )
}
    ...
    <>
      ...
      >
        ...
        <div className="p-4">
          ...
          <motion.button
            className={`w-full py-2.5 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 ${cartItem ? "bg-orange-300 hover:bg-orange-600" : "bg-orange-500 hover:bg-orange-600 text-white"
              }`}
